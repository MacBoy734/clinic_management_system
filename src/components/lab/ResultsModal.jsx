...
//   body: { status, item_results: [{ id, result, result_data, result_notes, flagged }] }

import { useState, useEffect } from 'react'
import { Icon, Badge, formatTime, Spinner } from '@/utils/helpers'
import {
...
function ResultItemCard({ item, patient, values, note, onFieldChange, onNoteChange }) {
  const template = item.catalog?.result_template

  // No catalog entry / no template — fall back to a plain text input so the
  // tech is never blocked, but flag it visually as unconfigured.
